...
Revision ID: e4c729f03f79
Revises: 
Create Date: 2023-03-26 22:53:35.287279
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['ad_id'], ['ads.id'], name=op.f('fk__data_ads__ad_id__ads')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk__data_ads'))
    )
